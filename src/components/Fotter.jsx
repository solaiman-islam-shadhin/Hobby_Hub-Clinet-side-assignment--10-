  ...
  return (
    <footer className="  border-t  border-base-content mt-5">
      <div className="footer p-2 md:p-5 flex justify-between">
        <div>
          <h2 className="text-xl md:text-2xl font-bold">Hobby Hub</h2>
          <p className=" max-w-md">Connect with like-minded people and discover amazing hobby groups in your area.</p>
        </div>
        <nav>
          ...
          {
            (user? <Link to="/dashboard" className="link link-hover">Dashboard</Link> : "")
          }
        </nav>
        <nav>
          <h6 className="footer-title">Support</h6>
          <Link to="/help" className="link link-hover">Help</Link>
      ...
      <div className="footer footer-center p-4  text-base-content ">
        <aside className="flex items-center gap-4">
          ...
          <p>© 2024 Hobby Hub - Connecting Communities Through Shared Passions</p>
        </aside>
      </div>
    </footer>
  )

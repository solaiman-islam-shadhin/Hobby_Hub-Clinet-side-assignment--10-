...
export const Login = () => {
  ...
  return (
    <div className="container mx-auto mb-10 md:p-6">
      <Fade direction='down' triggerOnce>
        <div className="w-full text-base-content rounded-lg ">
          <div className="py-5 text-center">

            <p className="text-xl md:text-2xl font-semibold   mt-2">Login to your Hobby Hub account</p>
          </div>
        </div>
      </Fade>

      <Fade direction='up' triggerOnce>
        <form onSubmit={handleSubmit} className="max-w-2xl mx-auto md:p-8">
